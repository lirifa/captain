...
/**************************** 加载datagrid 总账号信息列表 ******************************************************/
    $('#master_acct_table').datagrid({
        ...
        columns: [[
            ...
            {field: 'acc_num',title: '总账号',width: 200,editor: {type: 'validatebox',options: { required: true}}},
            {field: 'acc_name',title: '账号名',width: 200,editor: { type: 'validatebox', options: { required: true }}},
