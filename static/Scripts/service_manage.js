        ...
        columns: [[
            ...
            {field:'opt',title:'操作',width:150,align:'center',
                formatter: function(value, row, index) {
                    var str = '<a name="check-btn" href="javascript:check_stat();"  title="check">检查</a><a name="start-btn">启动</a><a name="stop-btn">停止</a><a name="restart-btn">重启</a>';
                    return str; 
                } 
            }, 
                ]], 
        ...
        $.ajax({
            ...
            success:function (msg) {
                ...
                for (i=0;i < rows.length;i++){
                    ...
                    $("a[name='check-btn']").linkbutton({text:'检查',plain:true,iconCls:'icon-reload'});
                    $("a[name='start-btn']").linkbutton({text:'启动',plain:true,iconCls:'icon-reload'});
                    $("a[name='stop-btn']").linkbutton({text:'停止',plain:true,iconCls:'icon-reload'});
                    $("a[name='restart-btn']").linkbutton({text:'重启',plain:true,iconCls:'icon-reload'});
                }
